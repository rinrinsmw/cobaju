...
describe('Stylist session UI', () => {
  ...
  it('restores saved completed messages and clears them after confirmation', async () => {
    const savedAt = Date.parse('2026-07-18T08:00:00.000Z')
    ...
    expect(JSON.parse(window.sessionStorage.getItem(getStylistSessionKey(7)) ?? '{}').updatedAt).toBe('2026-07-18T08:00:00.000Z')
